...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _spPnpJs = __webpack_require__(4);

	var _spPnpJs2 = _interopRequireDefault(_spPnpJs);

	var _webs = __webpack_require__(23);
	...
	angular.module('compassionIntranet').service('rssFeedService', ['$http', '$q', 'COM_CONFIG', function ($http, $q, COM_CONFIG) {
	    function getRssItems(user) {
	        var defer = $q.defer();
	        var web = new _webs.Web(COM_CONFIG.rootWeb);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var configuration_1 = __webpack_require__(10);
	var logging_1 = __webpack_require__(11);
	var rest_1 = __webpack_require__(12);
	var pnplibconfig_1 = __webpack_require__(6);
	/**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var fetchclient_1 = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var searchsuggest_1 = __webpack_require__(21);
	var site_1 = __webpack_require__(22);
	var webs_1 = __webpack_require__(23);
	var util_1 = __webpack_require__(5);
	var userprofiles_1 = __webpack_require__(46);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var exceptions_1 = __webpack_require__(18);
	var logging_1 = __webpack_require__(11);
	var pipeline_1 = __webpack_require__(19);
	/**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var queryable_1 = __webpack_require__(14);
	var lists_1 = __webpack_require__(24);
	...
	var util_1 = __webpack_require__(5);
	var lists_2 = __webpack_require__(24);
	var siteusers_1 = __webpack_require__(30);
	var usercustomactions_1 = __webpack_require__(41);
	var odata_1 = __webpack_require__(17);
	var features_1 = __webpack_require__(43);
	var decorators_1 = __webpack_require__(44);
	var queryableshareable_1 = __webpack_require__(26);
	var relateditems_1 = __webpack_require__(45);
	/**
	...
	var Web = function (_super) {
	    ...
	    __decorate([decorators_1.deprecated("2.0.7", "This method will be removed in future releases. Please use the methods found in queryable securable.")], Web.prototype, "doesUserHavePermissions", null);
	    return Web;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var items_1 = __webpack_require__(25);
	...
	var List = function (_super) {
	    ...
	    List.prototype.getListItemEntityTypeFullName = function () {
	        return this.clone(List, null).select("ListItemEntityTypeFullName").getAs().then(function (o) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var util_1 = __webpack_require__(5);
	var odata_1 = __webpack_require__(17);
	var attachmentfiles_1 = __webpack_require__(36);
	var lists_1 = __webpack_require__(24);
	/**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var items_1 = __webpack_require__(25);
	var queryableshareable_1 = __webpack_require__(26);
	var odata_2 = __webpack_require__(17);
	/**
	...
	var Files = function (_super) {
	    ...
	    Files.prototype.addTemplateFile = function (fileUrl, templateFileType) {
	        var _this = this;
	        return this.clone(Files, "addTemplateFile(urloffile='" + fileUrl + "',templatefiletype=" + templateFileType + ")").postCore().then(function (response) {
	            return {
	                data: response,
	...
	var File = function (_super) {
	    ...
	    File.prototype.startUpload = function (uploadId, fragment) {
	        return this.clone(File, "startUpload(uploadId=guid'" + uploadId + "')").postAsCore({ body: fragment }).then(function (n) {
	            return parseFloat(n);
	        });
	    };
	    /**
	    ...
	    File.prototype.continueUpload = function (uploadId, fileOffset, fragment) {
	        return this.clone(File, "continueUpload(uploadId=guid'" + uploadId + "',fileOffset=" + fileOffset + ")").postAsCore({ body: fragment }).then(function (n) {
	            return parseFloat(n);
	        });
	    };
	    /**
	    ...
	    File.prototype.finishUpload = function (uploadId, fileOffset, fragment) {
	        return this.clone(File, "finishUpload(uploadId=guid'" + uploadId + "',fileOffset=" + fileOffset + ")").postAsCore({ body: fragment }).then(function (response) {
	            return {
	                data: response,
	    ...
	    AttachmentFiles.prototype.addMultiple = function (files) {
	        ...
	        return files.reduce(function (chain, file) {
	            return chain.then(function () {
	                return _this.clone(AttachmentFiles, "add(FileName='" + file.name + "')").postCore({
	                    body: file.content
	                });
	            });
	        }, Promise.resolve());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var queryable_1 = __webpack_require__(14);
	var files_1 = __webpack_require__(47);
	var odata_1 = __webpack_require__(17);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var cachingConfigurationProvider_1 = __webpack_require__(54);
	exports.CachingConfigurationProvider = cachingConfigurationProvider_1.default;
	var spListConfigurationProvider_1 = __webpack_require__(55);
...
/***/ (function(module, exports) {
	...
	module.exports = "<section id=\"ci-toolbar-container\">\r\n    <div id=\"ci-toolbar\">\r\n        <ul>\r\n            <li><a href=\"#ci-apps\">apps + tools</a></li>\r\n            <li><a href=\"#ci-documents\">documents</a></li>\r\n            <li><a href=\"#ci-bookmarks\">bookmarks</a></li>\r\n            <li><a href=\"#ci-sites\">project sites</a></li>\r\n        </ul>\r\n        <div id=\"ci-apps\">\r\n            <ul ng-repeat=\"tool in myTools\">\r\n                <li>\r\n                    <a ng-href=\"{{ tool.iconUrl }}\">\r\n                        <img ng-src=\"{{ tool.iconUrl }}\" />\r\n                        <div>{{ tool.title }}</div>                        \r\n                    </a>                    \r\n                </li>\r\n            </ul>\r\n        </div>\r\n        <div id=\"ci-documents\">\r\n            <h3>Recent Documents</h3>\r\n            <ul>\r\n                <li><a>document name</a></li>\r\n            </ul>\r\n        </div>\r\n        <div id=\"ci-bookmarks\">\r\n            <ul>\r\n                <li><a>bookmark 1</a></li>\r\n            </ul>\r\n        </div>\r\n        <div id=\"ci-sites\">\r\n            <ul>\r\n                <li><a>site 1</a></li>\r\n            </ul>\r\n        </div>        \r\n    </div>\r\n    <div><a ng-click=\"ctrl.openModal('ci-toolbar-manage')\">Manage</a></div>\r\n    <modal id=\"ci-toolbar-manage\">\r\n        <div class=\"modal\">\r\n            <div class=\"modal-body\">\r\n                <h1>Manage My tools</h1>\r\n                <h3>Available Tools</h3>\r\n                \r\n                <ul ng-repeat=\"tool in allTools\">\r\n                    <li><input type=\"checkbox\" ng-model=\"tool.id\"  />{{tool.title}}</li>\r\n                </ul>\r\n\r\n                <button ng-click=\"ctrl.saveMyTools();\">Close</button>\r\n                <button ng-click=\"ctrl.closeModal('ci-toolbar-manage');\">Close</button>\r\n            </div>\r\n        </div>\r\n        <div class=\"modal-background\"></div>\r\n    </modal>\r\n</section>";

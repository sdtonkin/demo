...
/***/ (function(module, exports, __webpack_require__) {
	...
	myApp.controller(controllerName, ['$scope', 'common', 'spService', 'COM_CONFIG', function ($scope, common, spService, COM_CONFIG) {
	    ...
	    this.$onInit = function () {
	        ctrl.siteCollectionUrl = ctrl.siteCollectionUrl == null ? 'https://compassion.sharepoint.com/sites/stage-gco' : ctrl.siteCollectionUrl;

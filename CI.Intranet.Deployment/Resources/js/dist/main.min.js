...
/***/ (function(module, exports, __webpack_require__) {
	...
	var app = angular.module('compassionIntranet', []).config(function ($sceDelegateProvider) {
	    ...
	    'https://api.rss2json.com/**', 'https://api.ipify.org/**', 'https://api.yammer.com/**']);
	});
...
/***/ (function(module, exports) {
	...
	if (document.location.host === "compassion.sharepoint.com") {
	    if (document.location.pathname.toLowerCase().indexOf('/sites/stage') !== -1) {
	        myApp.constant('COM_CONFIG', {
	            ...
	            groupSites: ["https://compassion.sharepoint.com/sites/stage-cfo", "https://compassion.sharepoint.com/sites/stage-gco", "https://compassion.sharepoint.com/sites/stage-glo", "https://compassion.sharepoint.com/sites/stage-gme", "https://compassion.sharepoint.com/sites/stage-gp", "https://compassion.sharepoint.com/sites/stage-hr", "https://compassion.sharepoint.com/sites/stage-innovation"],
	        ...
	        myApp.constant('COM_CONFIG', {
	            ...
	            groupSites: ["https://compassion.sharepoint.com/sites/cfo", "https://compassion.sharepoint.com/site/gco", "https://compassion.sharepoint.com/sites/glo", "https://compassion.sharepoint.com/sites/gme", "https://compassion.sharepoint.com/sites/gp", "https://compassion.sharepoint.com/sites/hr", "https://compassion.sharepoint.com/sites/innovation"],
	            storage: [{ service: 'appService', key: 'CI_USER_APP_KEY', expire: 24, clearCommand: 'clearMyApps' }, { service: 'bookmarkService', key: 'CI_MY_BOOKMARKS_KEY', expire: 24, clearCommand: 'clearMyBookmarks' }, { service: 'employeeAnnouncementService', key: 'CI_EMPLOYEE_ANNOUNCEMENT_KEY', expire: 8, clearCommand: 'clearEmployeeAnnouncements' }, { service: 'globalPartnerService', key: 'CI_GLOBAL_PARTNER_KEY', expire: 0, clearCommand: 'clearGlobalPartners' }, { service: 'gratitudesService', key: 'CI_GRATITUDE_KEY', expire: 4, clearCommand: 'clearGratitudes' }, { service: 'groupService', key: 'CI_GROUPS_KEY', expire: 24, clearCommand: 'clearGroups' }, { service: 'navigationService', key: 'CI_NAVIGATION_KEY', expire: 0, clearCommand: 'clearNavNodes' }, { service: 'photoService', key: 'CI_INTRANET_PHOTOS', expire: 24, clearCommand: 'clearPhotos' }, { service: 'weatherService', key: 'CI_LOCATION_KEY', expire: 4, clearCommand: 'clearLocation' }, { service: 'weatherService', key: 'CI_WEATHER_KEY', expire: 2, clearCommand: 'clearWeather' }],
	            contentTypeIds: {
	                newsPage: '0x010100C568DB52D9D0A14D9B2FDCC96666E9F2007948130EC3DB064584E219954237AF390064DEA0F50FC8C147B0B6EA0636C4A7D400391165E9D2147C40AB7727C9F70AF24301',
	                event: '0x010200AA13DE23CACF40448F3C9C777ABC2106'
	...
	//Dev Tenant
	        ...
	        myApp.constant('COM_CONFIG', {
	            ...
	            groupSites: ["https://compassion.sharepoint.com/sites/stage-cfo", "https://compassion.sharepoint.com/site/stage-gco", "https://compassion.sharepoint.com/sites/stage-glo", "https://compassion.sharepoint.com/sites/stage-gme", "https://compassion.sharepoint.com/sites/stage-gp", "https://compassion.sharepoint.com/sites/stage-hr", "https://compassion.sharepoint.com/sites/stage-innovation"],
	            storage: [{ service: 'appService', key: 'CI_USER_APP_KEY', expire: 24, clearCommand: 'clearMyApps' }, { service: 'bookmarkService', key: 'CI_MY_BOOKMARKS_KEY', expire: 24, clearCommand: 'clearMyBookmarks' }, { service: 'employeeAnnouncementService', key: 'CI_EMPLOYEE_ANNOUNCEMENT_KEY', expire: 8, clearCommand: 'clearEmployeeAnnouncements' }, { service: 'globalPartnerService', key: 'CI_GLOBAL_PARTNER_KEY', expire: 0, clearCommand: 'clearGlobalPartners' }, { service: 'gratitudesService', key: 'CI_GRATITUDE_KEY', expire: 4, clearCommand: 'clearGratitudes' }, { service: 'groupService', key: 'CI_GROUPS_KEY', expire: 24, clearCommand: 'clearGroups' }, { service: 'navigationService', key: 'CI_NAVIGATION_KEY', expire: 0, clearCommand: 'clearNavNodes' }, { service: 'photoService', key: 'CI_INTRANET_PHOTOS', expire: 24, clearCommand: 'clearPhotos' }, { service: 'weatherService', key: 'CI_LOCATION_KEY', expire: 4, clearCommand: 'clearLocation' }, { service: 'weatherService', key: 'CI_WEATHER_KEY', expire: 2, clearCommand: 'clearWeather' }],
	            contentTypeIds: {
	                newsPage: '0x010100C568DB52D9D0A14D9B2FDCC96666E9F2007948130EC3DB064584E219954237AF390064DEA0F50FC8C147B0B6EA0636C4A7D400391165E9D2147C40AB7727C9F70AF24301',
	                event: '0x010200AA13DE23CACF40448F3C9C777ABC2106'
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('anniversaryService', ['$http', '$q', 'userProfileService', 'COM_CONFIG', 'common', function ($http, $q, userProfileService, COM_CONFIG, common) {
	    ...
	    ctrl.getAnniversary = function () {
	        ...
	        web.lists.getByTitle(COM_CONFIG.lists.anniversary).items.select('StartDate', 'COM_Contact/FirstName', 'COM_Contact/LastName', 'COM_Contact/SipAddress', '*').expand('COM_Contact').get().then(function (data) {
	            var events = [];
	            var items = data;
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$http', '$q', 'COM_CONFIG', 'storage', 'common', function ($http, $q, COM_CONFIG, storage, common) {
	    ...
	    function getUserAppItemsByName(userName) {
	        ...
	        if (!local.isExpired) defer.resolve(local);else {
	            var web = new $pnp.Web(COM_CONFIG.rootWeb);
	            web.lists.getByTitle(COM_CONFIG.lists.userApps).items.select('COM_ToolbarUser/SipAddress', 'Title', 'COM_UserToolbarId', 'COM_ListSortOrder', 'ID').filter("COM_ToolbarUser/SipAddress eq '" + userName + "'").expand('COM_ToolbarUser').get().then(function (data) {
	                var promises = new Array();
	                for (var i = 0; data.length > i; i++) {
	                    var p = getUserApp(data[i]);
	                    promises.push(p);
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$http', '$q', 'COM_CONFIG', 'storage', 'common', function ($http, $q, COM_CONFIG, storage, common) {
	    ...
	    function getUserBookmarkItemsByName(userName) {
	        ...
	        if (!local.isExpired) defer.resolve(local);else {
	            var web = new $pnp.Web(COM_CONFIG.rootWeb);
	            web.lists.getByTitle(COM_CONFIG.lists.userBookmarks).items.select('Id', 'COM_ToolbarUser/SipAddress', 'Title', 'COM_BookmarkUrl', 'COM_ListSortOrder').filter("COM_ToolbarUser/SipAddress eq '" + userName + "'").expand('COM_ToolbarUser').get().then(function (data) {
	                data.map(function (item) {
	                    if (item.Title) item.title = item.Title;
	                    if (item.COM_BookmarkUrl) item.url = item.COM_BookmarkUrl;
	                });
	    ...
	    function getPage(pageId, siteUrl) {
	        ...
	        web.lists.getByTitle('Pages').items.select('Title').getById(pageId).get().then(function (item) {
	            defer.resolve(item);
	        });
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('contactService', ['$http', '$q', 'COM_CONFIG', 'common', 'storage', function ($http, $q, COM_CONFIG, common, storage) {
	    ...
	    ctrl.getContacts = function (siteCollectionUrl) {
	        var defer = $q.defer();
	        var web = new $pnp.Web(siteCollectionUrl);
	        web.lists.getByTitle(COM_CONFIG.lists.contacts).items.select('Id', 'JobTitle', 'Email', 'COM_Contact/SipAddress', 'COM_Contact/FirstName', 'COM_Contact/LastName').expand('COM_Contact').get().then(function (data) {
	            var contact = data;
	            var response = [];
	...
	angular.module('compassionIntranet').service('documentService', ['$http', '$q', 'COM_CONFIG', function ($http, $q, COM_CONFIG) {
	    function getMyDocuments(user) {
	        ...
	        $pnp.sp.search({
	            ...
	            if (!COM_CONFIG.isProduction) {
	                console.log('getMyDocuments', results);
	            }
	        });
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$http', '$q', 'COM_CONFIG', 'storage', 'common', function ($http, $q, COM_CONFIG, storage, common) {
	    ...
	    function getEmployeeAnnouncements() {
	        ...
	        web.lists.getByTitle(COM_CONFIG.lists.employeeAnnouncements).items.filter("COM_PublishDate le '" + today + "' and COM_ExpirationDate gt '" + today + "'").get().then(function (data) {
	            data.map(function (item) {
	                if (item.Title) {
	    ...
	    angular.module('compassionIntranet').service('graphService', ['$http', '$q', 'COM_CONFIG', 'common', function ($http, $q, COM_CONFIG, common) {
	        ...
	        ctrl.searchMyUsers = function (queryText) {
	            ...
	            $http(request).then(function (data) {
	                ...
	                defer.reject(data);
	                if (!COM_CONFIG.isProduction) {
	                    console.log('search my users', JSON.stringify(data));
	                }
	            });
	            return defer.promise;
	        };
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$http', '$q', 'COM_CONFIG', 'common', 'userProfileService', function ($http, $q, COM_CONFIG, common, userProfileService) {
	    ...
	    ctrl.getGratitudes = function () {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.gratitudes).items.select('COM_GratitudeType', 'COM__x0020_GratitudeDescription', 'COM_Contact/FirstName', 'COM_Contact/LastName', 'COM_Contact/SipAddress', 'Author/SipAddress', 'Author/FirstName', 'Author/LastName').expand('COM_Contact', 'Author').get().then(function (data) {
	            if (!COM_CONFIG.isProduction) {
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('howDoIService', ['$http', '$q', 'COM_CONFIG', 'common', 'storage', function ($http, $q, COM_CONFIG, common, storage) {
	    ...
	    ctrl.gethowDoI = function () {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.workResources).items.filter("COM_ResourceType eq 'How Do I'").get().then(function (data) {
	            data.map(function (item) {
	                if (item.COM_LinkUrl) item.url = item.COM_LinkUrl.Url;
	                if (item.COM_ToolbarIconUrl) item.iconUrl = item.COM_ToolbarIconUrl;
	                if (item.Title) item.title = item.Title;
	            });
	            if (!COM_CONFIG.isProduction) {
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('newHireService', ['$http', '$q', 'userProfileService', 'COM_CONFIG', 'common', function ($http, $q, userProfileService, COM_CONFIG, common) {
	    ...
	    ctrl.getHire = function () {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.newHire).items.select('StartDate', 'COM_Contact/FirstName', 'COM_Contact/LastName', 'COM_Contact/SipAddress').expand('COM_Contact').get().then(function (data) {
	            var newHires = [];
	            var items = data;
	            for (var i = 0; i < items.length; i++) {
	                var item = items[i];
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$http', '$q', 'COM_CONFIG', 'storage', 'common', function ($http, $q, COM_CONFIG, storage, common) {
	    ...
	    function getPhotos() {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.missionPhotos).items.select('COM_PhotoCaption', 'EncodedAbsUrl', 'Created').orderBy('Created', false).top(4).get().then(function (data) {
	            var photos = [];
	            for (var i = 0; i < data.length; i++) {
	                var p = data[i];
	                var photo = {};
...
/***/ (function(module, exports) {
	...
	myApp.service('relatedNewsService', function ($q, $http, COM_CONFIG) {
	    ...
	    var getPage = function getPage() {
	        ...
	        var listItemId = _spPageContextInfo.pageItemId;
	        var web = new $pnp.Web(COM_CONFIG.newsWeb);

	        web.lists.getByTitle('Pages').items.getById(listItemId).get().then(function (data) {
	            data.map(function (item) {
	                if (item.RefinableString01) {
	                    item.newsType = item.RefinableString01;
	                }
	    ...
	    function getRelatedNewsByType(newsType) {
	        ...
	        web.lists.getByTitle('Pages').items.filter('COM_NewsType eq ' + newsType).top(3).orderBy('COM_PublishDate', false).get().then(function (data) {
	            data.map(function (item) {
	                if (item.RefinableString01) {
	                    item.newsType = item.RefinableString01;
	                }
	            ...
	            if (!COM_CONFIG.isProduction) {
	                console.log('getRelatedNewsByType', data);
	            }
	            if (data.length > 0) {
	                defer.resolve(data.PrimarySearchResults[0]);
	            } else {
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('resourceLinksService', ['$http', '$q', 'COM_CONFIG', 'common', 'storage', function ($http, $q, COM_CONFIG, common, storage) {
	    ...
	    ctrl.getresourceLinks = function () {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.workResources).items.filter("COM_ResourceType eq 'Resource'").get().then(function (data) {
	            data.map(function (item) {
	                if (item.COM_LinkUrl) item.url = item.COM_LinkUrl.Url;
	                if (item.COM_ToolbarIconUrl) item.iconUrl = item.COM_ToolbarIconUrl.Url;
	                if (item.Title) item.title = item.Title;
	            });
	            if (!COM_CONFIG.isProduction) {
	                console.log('getRelatedNews', items);
	    ...
	    function getRssFeed(feed) {
	        ...
	        $http.jsonp(COM_CONFIG.rssProxyUrl + encodeURIComponent(feed.url)).then(function (response) {
	            ...
	            for (var i = 0; i < feeds.length; ++i) {
	                ...
	                if (f.guid.startsWith('http')) f.link = f.guid;
	            }
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('userProfileService', ['$http', '$q', 'COM_CONFIG', function ($http, $q, COM_CONFIG) {
	    ...
	    function getUserFromUserInfo(id) {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.userInfo).items.getById(id).get().then(function (data) {
	            defer.resolve(data);
	        });
...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service(serviceName, ['$q', '$http', 'COM_CONFIG', 'storage', 'common', function ($q, $http, COM_CONFIG, storage, common) {
	    ...
	    ctrl.getLocationFromIpAddress = function (ipAddress) {
	        ...
	        $http.get(url).then(function (data, status, headers) {
	    ...
	    ctrl.getLocationFromLatLong = function (latitude, longitude) {
	        ...
	        $http.get(url).then(function (data, status, headers) {
	            var loc = _.filter(data.data.results, function (d) {
	                return _.contains(d.types, 'locality');
	            });
	            if (loc.length == 0) {
	                if (!COM_CONFIG.isProduction) {
...
/***/ (function(module, exports) {
	...
	module.exports = "<section>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"event in events | limitTo:2:0 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{event.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{event.targetName}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{event.targetName}}</h3>\r\n                    <p>{{event.description}}</p>                \r\n                    <span class=\"submit-line\">Start Date: {{event.startDate}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"event in events | limitTo:2:2 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{event.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{event.targetName}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{event.targetName}}</h3>\r\n                    <p>{{event.description}}</p>\r\n                    <span class=\"submit-line\">{{event.startDate}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"bookmark\" ng-show=\"!ctrl.isMyBookmark()\">\r\n    <a ng-click=\"ctrl.addMyBookmark()\">\r\n        <span class=\"\">Bookmark<i class=\"fa fa-bookmark-o\" aria-hidden=\"true\"></i></span>\r\n    </a>\r\n</div>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"key-contacts\">\r\n    <div class=\"row\">\r\n        <div class=\"col-12\" ng-repeat=\"contact in ctrl.contacts track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-src=\"{{contact.picUrl}}\" image-alt-text=\"{{contact.name}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{contact.name}}</h3>\r\n                    <h5 class=\"emp-title\">{{contact.title}}</h5>\r\n                    <span class=\"emp-contact\">\r\n                        <a href=\"mailto:{{contact.email}}\">Email</a> \r\n                        <span class=\"emp-view\"><a ng-href=\"{{contact.profileUrl}}\" target=\"_blank\">View Profile</a></span>\r\n                    </span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"employee-announcement\" ng-if=\"ctrl.announcements.length > 0\">\r\n<div class=\"row\" ng-repeat=\"announcement in ctrl.announcements track by $index\">\r\n    <div class=\"col-md-6\">\r\n        <div class=\"media employee-card announce\">\r\n            <i class=\"fa fa-calendar d-flex align-self-start\" aria-hidden=\"true\" ng-if=\"announcement.iconUrl == null\"></i>\r\n            <image-loader image-src=\"{{announcement.iconUrl}}\" image-width=\"46\" image-height=\"46\" ng-if=\"announcement.iconUrl != null\"></image-loader>\r\n            <div class=\"media-body\">\r\n                <span class=\"mt-0 emp-announce\">{{announcement.title}}</span>\r\n                <span class=\"emp-info\">{{announcement.message}}</span>\r\n\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n</section>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"people-places news-events\">\r\n    <ul class=\"nav nav-tabs\">\r\n        <li class=\"nav-item\" ng-click=\"toggleActiveTab('US')\">\r\n            <a class=\"nav-link alt\" ng-class=\"{active: activeTab == 'US'}\">US</a>\r\n        </li>\r\n        <li class=\"nav-item\" ng-click=\"toggleActiveTab('Global')\">\r\n            <a class=\"nav-link alt\" ng-class=\"{active: activeTab == 'Global'}\">Global</a>\r\n        </li>\r\n    </ul>\r\n    <div class=\"ci-people\" ng-show=\"activeTab == 'US'\">\r\n        <employee-announcement></employee-announcement>\r\n        <us-links></us-links>\r\n    </div>\r\n    <div class=\"ci-places\" ng-show=\"activeTab == 'Global'\">\r\n        <global-links></global-links>\r\n    </div>\r\n    <input id=\"ci-pp-activeTab\" type=\"hidden\" ng-model=\"ctrl.activeTab\" />\r\n</section>\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"employee-spotlight\">\r\n    <div class=\"container\">\r\n        <div class=\"row\">\r\n            <h2 class=\"section\">Our People</h2>\r\n            <div class=\"employee-spotlight-tabs\">\r\n                <ul class=\"nav nav-tabs\">\r\n                    <li class=\"nav-item\">\r\n                        <a class=\"nav-link\"  ng-click=\"activeTab = 'g'\" ng-class=\"{active: activeTab == 'g'}\">skippys</a>\r\n                    </li>\r\n                    <li class=\"nav-item\">\r\n                        <a class=\"nav-link\" ng-click=\"activeTab = 'h'\" ng-class=\"{active: activeTab == 'h'}\">new hires</a>\r\n                    </li>\r\n                    <li class=\"nav-item\">\r\n                        <a class=\"nav-link\" ng-click=\"activeTab = 'a'\" ng-class=\"{active: activeTab == 'a'}\">anniversaries + retirements</a>\r\n                    </li>\r\n                </ul>\r\n                <div class=\"tab-content\">\r\n                    <div ng-show=\"activeTab == 'g'\">\r\n                        <gratitudes></gratitudes>\r\n                    </div>\r\n                    <div ng-show=\"activeTab == 'h'\">\r\n                        <new-hires></new-hires>\r\n                    </div>\r\n                    <div ng-show=\"activeTab == 'a'\">\r\n                        <anniversary-cards></anniversary-cards>\r\n                    </div>\r\n                </div>\r\n                <div class=\"row employee-spotlight-cta\" ng-if=\"activeTab == 'g'\">\r\n                    <div class=\"col\">\r\n                        <a class=\"btn btn-block blue\" ng-click=\"submitGratitude()\">Submit a Skippy</a>\r\n                    </div>\r\n                    <div class=\"col\">\r\n                        <a class=\"btn btn-cta pull-right\" href=\"{{viewAllUrl}}\">View All Skippys</a>\r\n                    </div>\r\n                </div>\r\n                <div class=\"row employee-spotlight-cta\" ng-if=\"activeTab == 'h'\">\r\n                    <div class=\"col\">\r\n                        <a class=\"btn btn-cta pull-right\" href=\"{{viewAllHiresUrl}}\">View All Hires</a>\r\n                    </div>\r\n                </div>\r\n                <div class=\"row employee-spotlight-cta\" ng-if=\"activeTab == 'a'\">\r\n                    <div class=\"col\">\r\n                        <a class=\"btn btn-cta pull-right\" href=\"{{viewAllAnniversaryUrl}}\">View All</a>\r\n                    </div>\r\n                </div>\r\n\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"location-places\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-6\" ng-repeat=\"group in ctrl.globalGroups track by $index\">\r\n            <div class=\"card\"> \r\n                <h5>{{group.name}}</h5>\r\n                <ul>\r\n                    <li ng-repeat=\"link in group.Nodes track by $index\">\r\n                        <a ng-href=\"#\">\r\n                            {{link.name}}\r\n                        </a>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n</section>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	myApp.controller(ctrlName, ['$scope', 'gratitudesService', 'COM_CONFIG', function ($scope, gratitudesService, COM_CONFIG) {
	    var ctrl = this;
	    ctrl.gratitudes = [], ctrl.card1 = {}, ctrl.card2 = {}, ctrl.card3 = {}, ctrl.card4 = {};
	    this.$onInit = function () {
...
/***/ (function(module, exports) {
	...
	module.exports = "<section>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"grat in gratitudes | limitTo:2:0 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{grat.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{grat.targetName}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{grat.targetName}}</h3>\r\n                    <h5 class=\"emp-rec\">{{grat.type}}</h5>\r\n                    <p>{{grat.description}}</p>\r\n                    <span class=\"submit-line\">Submitted by: {{grat.submittedBy}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"grat in gratitudes | limitTo:2:2 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{grat.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{grat.targetName}}\" img-width=\"48px\" img-height=\"48px\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{grat.targetName}}</h3>\r\n                    <h5 class=\"emp-rec\">{{grat.type}}</h5>\r\n                    <p>{{grat.description}}</p>\r\n                    <span class=\"submit-line\">Submitted by: {{grat.submittedBy}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>    \r\n</section>\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"how-do-i\">\r\n    <div class=\"row\">\r\n        <div class=\"col-12\">\r\n            <ul class=\"nav nav-pills nav-fill\">\r\n                <h3>How Do I?</h3>\r\n                <li class=\"nav-item\" ng-repeat=\"link in ctrl.howDoI track by $index\">\r\n                    <a class=\"nav-link\" href=\"{{ link.url }}\">\r\n                        <span>{{ link.title }}</span>\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</section>\r\n";
	        ...
	        taxonomyService.getTermFromMasterTermsetByGuid(COM_CONFIG.termSets.locationTermId).then(function (data) {
	            ...
	            for (var i = 0; i < ctrl.places.length; i++) {
	                ctrl.places[i].Nodes.map(function (item) {
	                    if (item.CustomProperties["SiteUrl"] != null) item.siteUrl = item.CustomProperties["SiteUrl"];else item.siteUrl = '';
	                });
	            }
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"location-places\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-6\" ng-repeat=\"place in ctrl.places track by $index\">\r\n            <div class=\"card\">\r\n                 <h5>{{place.name}}</h5>       \r\n                <ul>\r\n                    <li ng-repeat=\"country in place.Nodes track by $index\">\r\n                        <a ng-href=\"{{country.siteUrl}}\" target=\"_blank\">\r\n                            {{country.name}}\r\n                        </a>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n</section>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<ul ng-repeat=\"app in ctrl.myApps track by $index\">\r\n    <li >\r\n        <a ng-href=\"{{ app.url }}\" target=\"_blank\">\r\n            <img ng-src=\"{{ app.iconUrl }}\" class=\"app-icon\" />\r\n            <div>{{ app.title }}</div>\r\n        </a>\r\n    </li>\r\n</ul>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<ul ng-repeat=\"bk in ctrl.myBookmarks track by $index\">\r\n    <li>\r\n        <a ng-href=\"{{ bk.url }}\">\r\n            <div>{{ bk.title }}</div>                        \r\n        </a>                    \r\n    </li>\r\n</ul>\r\n    ";
	...
	myApp.controller(controllerName, ['$scope', '$q', 'COM_CONFIG', 'userProfileService', function ($scope, $q, COM_CONFIG, userProfileService) {
	    ...
	    this.$onInit = function () {
	        ...
	        userProfileService.getCurrentUserProfile().then(function (data) {
	            ...
	            if (!COM_CONFIG.isProduction) {
	                console.log('getCurrentUserProfile', department);
	            }
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"my-department\" ng-show=\"ctrl.toggleVisibility()\">\r\n    <h2 class=\"section\">My Department</h2>\r\n\r\n   <!--  <div class=\"card row\" ng-repeat=\"person in ctrl.myDepartment track by $index\">\r\n        <div class=\"col-sm-4\">\r\n            <img class=\"emp-photo\" ng-src=\"{{person.picUrl}}\" />\r\n        </div>\r\n        <div class=\"col-sm-8\">\r\n            <div>{{person.title}}</div>\r\n            <div>{{person.jobTitle}}</div>\r\n            <div class=\"row\">\r\n                <div class=\"col-sm-5\">\r\n                    <a ng-href=\"mailto: {{person.email}}\">\r\n                        {{person.email}}\r\n                    </a>                    \r\n                </div>\r\n                <div class=\"col-sm-2\">|</div>\r\n                <div class=\"col-sm-5\">\r\n                    <a ng-href=\"{{person.profileUrl}}\">View Profile</a>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div> -->\r\n    <div class=\"media employee-card\" ng-repeat=\"person in ctrl.myDepartment track by $index\">\r\n        <img class=\"d-flex align-self-start mr-3 emp-photo\" ng-src=\"{{person.picUrl}}\" alt=\"Employee photo\">\r\n        <div class=\"media-body\">\r\n          <h3 class=\"mt-0 emp-name\">{{person.title}}</h3>\r\n          <h5 class=\"emp-title\">{{person.jobTitle}}</h5>\r\n          <span class=\"emp-contact\"><a ng-href=\"mailto:{{person.email}}\">Email</a> <span class=\"emp-view\"><a ng-href=\"{{person.profileUrl}}\">View Profile</a></span></span>\r\n        </div>\r\n    </div>\r\n\r\n</section>\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section ng-show=\"!lowBandwidth\">\r\n    <div class=\"card world-news\" ng-show=\"ctrl.myFeeds.length == 0\">\r\n        <div class=\"card-body\">\r\n            <h2 class=\"section\">World News</h2>\r\n            <p class=\"card-text\">\r\n                Save your favorite external news sites for easy access. News headlines will be updated in real-time.\r\n            </p>\r\n            <a class=\"btn btn-block\" ng-click=\"ctrl.showManager = true;\">Get Started</a>\r\n        </div>\r\n    </div>\r\n\r\n    <rss-feeds ng-show=\"!ctrl.myFeeds.length == 0\"></rss-feeds>\r\n    <rss-feed-manager ng-show=\"!ctrl.myFeeds.length == 0\"></rss-feed-manager>\r\n</section>\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section>\r\n    <ul ng-repeat=\"site in ctrl.mySites track by $index\">\r\n        <li>\r\n            <a ng-href=\"{{ site.Path }}\">\r\n                <div>{{ site.Title }}</div>\r\n            </a>\r\n        </li>\r\n    </ul>\r\n</section>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	myApp.controller(controllerName, ['$scope', 'navigationService', 'storage', 'COM_CONFIG', function ($scope, navigationService, storage, COM_CONFIG) {
	    ...
	    ctrl.activeNavNode = function (node) {
	        ...
	        if (node.url.toLowerCase().endsWith(pageUrl)) return true;
	        if (node.url.endsWith(siteUrl)) return true;
	        if (_.contains(COM_CONFIG.groupSites, window.location.origin + siteUrl) && node.title == 'Groups') return true;
	        return false;
	    };
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"container\">\r\n<nav class=\"navbar navbar-expand-lg\">\r\n  <a class=\"navbar-brand\" ng-href=\"{{ ctrl.rootSiteUrl }}\"><img src=\"/sites/stage/_catalogs/masterpage/Compassion/images/skippy-white.png\" /></a>\r\n\r\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\r\n    <span class=\"navbar-toggler-icon\"><i class=\"fa fa-bars\" aria-hidden=\"true\"></i>\r\n</span>\r\n  </button>\r\n\r\n  <div class=\"collapse navbar-collapse\" id=\"navbarContent\">\r\n    <ul class=\"navbar-nav mr-auto\">\r\n      <li ng-repeat=\"node in ctrl.navNodes\" class=\"nav-item\">\r\n            <a ng-href=\"{{ node.url }}\" ng-class=\"{active: ctrl.activeNavNode(node)}\">\r\n                <div>{{ node.title }}</div>\r\n            </a>\r\n        </li>\r\n    </ul>\r\n    <div class=\"form-inline my-2 my-lg-0\">     \r\n      <div class=\"search-button\">\r\n            <a ng-click=\"ctrl.goSearch()\" class=\"search-glass\">\r\n                <i class=\"fa fa-search\"></i>\r\n            </a>           \r\n            <a class=\"search-close\" ng-click=\"ctrl.toggleSearchBox()\">\r\n                <i class=\"fa fa-search\"></i>\r\n                <span ng-bind=\"ctrl.searchTitle\"></span>\r\n            </a>            \r\n        </div>\r\n        <div class=\"search-background\" style=\"display: none;\">\r\n            <input id=\"searchQueryTerm\" type=\"text\" value=\"Search\" ng-model=\"searchTerm\" />\r\n        </div>\r\n    </div>\r\n  </div>\r\n</nav>\r\n</div>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"hire in newHires | limitTo:2:0 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{hire.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{hire.targetName}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{hire.targetName}}</h3>                    \r\n                    <span class=\"submit-line\">Start Date: {{hire.startDate}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row employee-card-container\">\r\n        <div class=\"col-md-6 employee-card-wrapper\" ng-repeat=\"hire in newHires | limitTo:2:2 track by $index\">\r\n            <div class=\"media employee-card\">\r\n                <image-loader image-src=\"{{hire.targetPicUrl}}\" image-css-class=\"d-flex align-self-start mr-3 emp-photo\" image-alt-text=\"{{hire.targetName}}\"></image-loader>\r\n                <div class=\"media-body\">\r\n                    <h3 class=\"mt-0 emp-name\">{{hire.targetName}}</h3>\r\n                    <span class=\"submit-line\">Start Date: {{hire.startDate}}</span>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>\r\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.controller(ctrlName, ['$scope', '$q', '$location', 'newsService', 'taxonomyService', 'yammerApiService', 'pagerService', 'COM_CONFIG', 'common', function ($scope, $q, $location, newsService, taxonomyService, yammerApiService, pagerService, COM_CONFIG, common) {
	    ...
	    ctrl.categories = [];
	    ctrl.regions = [];
	    ctrl.sortOptions = [{ title: 'Newest First', direction: 'dsc' }, { title: 'Oldest First', direction: 'asc' }];
	    ctrl.newsArticles = [];
	    ctrl.events = [];
	    ctrl.activeTab = 'news';
	    ...
	    function getData() {
	        ...
	        $q.all([p1, p2, p3, p4, p5]).then(function (data) {
	            if (!COM_CONFIG.isProduction) {
	                console.log('news and events', data);
	            }
	    ...
	    function checkForNewsTypeInUrl() {
	        ...
	        if (activeTab != '') ctrl.activeTab = activeTab;
...
/***/ (function(module, exports) {
	...
	module.exports = "<span class=\"card-likes\" ng-show=\"ctrl.likeCount != null\"><i class=\"fa fa-heart-o\"></i>{{ctrl.likeCount}}</span>";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"photo-share stay-connected\" ng-if=\"!isLowBandwidth\">\r\n  <div class=\"container\">\r\n    <div class=\"row\">\r\n      <div class=\"col\">\r\n        <h2 class=\"section\">Compassion Snapshots</h2>\r\n        <h4>Stay connected with Compassion International</h4>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-3 col-md-6\" ng-repeat=\"photo in ctrl.photos | limitTo: 4 track by $index\">\r\n            <div class=\"photo-container\">\r\n              <img ng-src=\"{{photo.source}}\" class=\"img-fluid\">\r\n              <p>{{photo.description}}</p>\r\n            </div>\r\n          </div>\r\n      </div>\r\n    <div class=\"row share-buts\">\r\n        <div class=\"col-md-3\">\r\n            <a class=\"btn btn-block blue\" ng-click=\"ctrl.displayNewPhotoForm()\">Share your photos</a>\r\n        </div>\r\n        <div class=\"col-md-8\">\r\n            <a class=\"btn btn-cta pull-right view-all-photos\" href=\"{{viewAllUrl}}\">View All Photos</a>\r\n        </div>\r\n    </div>\r\n</div>\r\n</section>\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"people-places news-events\">\r\n    <ul class=\"nav nav-tabs\">\r\n        <li class=\"nav-item\" ng-click=\"ctrl.toggleActiveTab('people')\">\r\n            <a class=\"nav-link alt\" ng-class=\"{active: ctrl.activeTab == 'people'}\">People</a>\r\n        </li>\r\n        <li class=\"nav-item\" ng-click=\"ctrl.toggleActiveTab('places')\">\r\n            <a class=\"nav-link alt\" ng-class=\"{active: ctrl.activeTab == 'places'}\">Places</a>\r\n        </li>\r\n    </ul>\r\n    <div class=\"ci-people\" ng-show=\"ctrl.activeTab == 'people'\">\r\n        <find-people></find-people>\r\n    </div>\r\n    <div class=\"ci-places\" ng-show=\"ctrl.activeTab == 'places'\">\r\n        <h4>Locations by Region</h4>\r\n        <location-places></location-places>        \r\n    </div>\r\n    <input id=\"ci-pp-activeTab\" type=\"hidden\" ng-model=\"ctrl.activeTab\" />\r\n</section>\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"related-news\"> \r\n    <div class=\"row\">\r\n        <div class=\"col\">\r\n            <h2 class=\"section\">Related Articles</h2>\r\n        </div>\r\n    </div>  \r\n    <div class=\"card related\">\r\n        <div class=\"card-body\">\r\n            <img class=\"img-card\" src=\"{{topImageUrl}}\" alt=\"\">\r\n        </div>\r\n    </div>\r\n    <div class=\"card related\" ng-repeat=\"article in news track by $index\">\r\n        <div class=\"card-body\">\r\n            <p class=\"card-date\">{{article.articleDate}}</p>\r\n            <a ng-href=\"{{article.Path}}\">\r\n                <p class=\"card-text\">{{article.Title}}</p>\r\n            </a>\r\n            <news-page-likes page-url=\"{{article.Path}}\"></news-page-likes>\r\n        </div>\r\n    </div>\r\n    <div ng-if=\"notFound\" class=\"card related\">\r\n        <span class=\"card-text\">{{notFound}}</span>\r\n    </div>\r\n</section>\r\n\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"work-resources\">\r\n    <div class=\"row\">\r\n        <div class=\"col-12\">\r\n            <h2 class=\"section\">Work Resources</h2>\r\n        </div>\r\n    </div>\r\n        <div class=\"row news-events\">\r\n                <div class=\"col-12\">\r\n                    <div class=\"col-lg-8 search-filter\">\r\n                        <div class=\"input-group search\">\r\n                            <input type=\"text\" class=\"form-control\" placeholder=\"Search content in Work Resources\" ng-model=\"searchText\">\r\n                            <span class=\"input-group-btn\">\r\n                                <button ng-click=\"ctrl.goSearch()\" class=\"btn btn-input\" type=\"button\"><i class=\"fa fa-search\"></i></button>\r\n                            </span>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n        </div>\r\n        <div class=\"row\">\r\n            <div class=\"col-12\">\r\n                <h2 class=\"section\">Or Browse by Category</h2>\r\n            </div>\r\n        </div>\r\n        <div class=\"row\">\r\n            <div class=\"col-12\">\r\n                <ul class=\"nav nav-pills nav-fill\">\r\n                        <li class=\"nav-item\" ng-repeat=\"link in ctrl.resourceLinks\">\r\n                            <a class=\"nav-link\" ng-href=\"{{ link.url }}\">\r\n                                <img ng-src=\"{{ link.iconUrl }}\" />\r\n                                <span>{{ link.title }}</span>\r\n                            </a>\r\n                        </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<section>\r\n    <div class=\"card world-news\">\r\n        <div class=\"card-body\">\r\n            <h2 class=\"section\">World News</h2>\r\n            <ul ng-repeat=\"item in ctrl.myFeeds\" class=\"rss-feed\">\r\n                <a ng-click=\"toggleActiveFeed(item.id)\">                    \r\n                    <span class=\"rss-category\">\r\n                        <i class=\"fa fa-plus\" ng-show=\"activeFeedId != item.id\"></i>\r\n                        <i class=\"fa fa-minus\" ng-show=\"activeFeedId == item.id\"></i>\r\n                        {{ item.title }}\r\n                    </span>\r\n                </a>                \r\n                <li ng-repeat=\"article in item.articles\" class=\"row\" ng-show=\"activeFeedId == item.id\">\r\n                    <div class=\"col-9 rss-title\">                        \r\n                        <a href=\"{{ article.link }}\" target=\"_blank\">{{ article.title }}</a>\r\n                    </div>\r\n                    <div class=\"col-3 rss-date\">\r\n                        {{ article.publishedSpanString }}\r\n                    </div>\r\n                    <div class=\"col-12 rss-divider\"><hr></div>\r\n                </li>               \r\n            </ul>\r\n        </div>\r\n    </div>\r\n</section>\r\n\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"submit\">\r\n    <a ng-click=\"ctrl.submitNews()\">\r\n        <span class=\"\">Submit a Story<i class=\"fa fa-lightbulb-o\" aria-hidden=\"true\"></i></span>\r\n    </a>\r\n</div>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	myApp.controller(controllerName, ['$scope', '$q', 'common', 'modalService', 'appService', 'bookmarkService', 'COM_CONFIG', function ($scope, $q, common, modalService, appService, bookmarkService, COM_CONFIG) {
	    ...
	    $scope.$parent.$watch('ctrl.selectedTabId', function (newVal, oldVal, scope) {
	        if (newVal == null) return;
	        if (!COM_CONFIG.isProduction) {
	            console.log('selecteed tab id', newVal);
	        }
	    ...
	    ctrl.enableAddNewButton = function () {
	        if (!ctrl.isAddNewDirty) $scope.systemMessage = '';
	    ...
	    function getAppsToDelete(master, apps) {
	        ...
	        for (var i = 0; i < master.length; i++) {
	            var app = master[i];
	            var item = _.filter(apps, function (x) {
	                return x.appId == app.appId;
	            });
	            if (item.length == 0) response.push(app);
	        }
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"location-places\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-6\" ng-repeat=\"group in groups track by $index\">\r\n            <div class=\"card\">\r\n                <h5>{{group.name}}</h5>\r\n                <ul>\r\n                    <li ng-repeat=\"link in group.Nodes track by $index\">\r\n                        <a ng-href=\"#\">\r\n                            {{link.name}}\r\n                        </a>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n</section>";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	myApp.controller(controllerName, ['$scope', 'weatherService', 'COM_CONFIG', 'storage', function ($scope, weatherService, COM_CONFIG, storage) {
	    var ctrl = this,
	        ...
	        weather;
	    var store = _.where(COM_CONFIG.storage, function (s) {
	        return s.service = 'weatherService';
	    });
	    var locationStore = _.find(store, function (l) {
	        return l.key.indexOf('LOCATION') != -1;
	    });

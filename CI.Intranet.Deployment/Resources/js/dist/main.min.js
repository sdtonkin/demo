...
/***/ (function(module, exports, __webpack_require__) {
	...
	app.controller(ctrlName, ['$scope', '$location', 'newsService', 'taxonomyService', 'COM_CONFIG', function ($scope, $location, newsService, taxonomyService, COM_CONFIG) {
	    ...
	    ctrl.categories = [];
	    ctrl.regions = [];
	    ctrl.sortOptions = [{ title: 'By Date' }];
	    ctrl.newsArticles = [];
	    ctrl.events = [];
	    ctrl.activeTab = 'news';
...
/***/ (function(module, exports) {
	...
	module.exports = "<span class=\"card-likes\"><i class=\"fa fa-heart-o\"></i>{{ctrl.likeCount}}</span>";

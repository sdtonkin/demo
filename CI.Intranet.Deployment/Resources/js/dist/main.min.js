...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('photoService', ['$http', '$q', 'COM_CONFIG', 'storage', 'common', function ($http, $q, COM_CONFIG, storage, common) {
	    ...
	    function getPhotos() {
	        var defer = $q.defer();
	        var web = new $pnp.Web(COM_CONFIG.rootWeb);
	        web.lists.getByTitle(COM_CONFIG.lists.missionPhotos).items.select('COM_PhotoCaption', 'EncodedAbsUrl').get().then(function (data) {
	            var photos = [];
	            for (var i = 0; i < data.length; i++) {
	                var p = data[i];
	                var photo = {};
...
/***/ (function(module, exports) {
	...
	myApp.service('relatedNewsService', function ($q, $http, COM_CONFIG) {
	    ...
	    var getPage = function getPage() {
	        ...
	        var pageTitle = $(".news-title-block > p.card-text").text();

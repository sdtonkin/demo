...
/***/ (function(module, exports) {
	...
	angular.module('compassionIntranet').service('contactService', ['$http', '$q', 'COM_CONFIG', 'common', 'storage', function ($http, $q, COM_CONFIG, common, storage) {
	    ...
	    ctrl.getContacts = function (siteCollectionUrl) {
	        ...
	        web.lists.getByTitle(COM_CONFIG.lists.contacts).items.get().then(function (data) {
	            var contact = data;
	            var response = [];
...
/***/ (function(module, exports) {
	...
	module.exports = "<section class=\"my-department\">\r\n    <h2 class=\"section\">Key Contacts</h2>\r\n    <div class=\"media employee-card\" ng-repeat=\"person in ctrl.contact track by $index\">\r\n        <img class=\"d-flex align-self-start mr-3 emp-photo\" ng-src=\"{{person.picUrl}}\" alt=\"Employee photo\">\r\n        <div class=\"media-body\">\r\n            <h3 class=\"mt-0 emp-name\">{{person.title}}</h3>\r\n            <h5 class=\"emp-title\">{{person.jobTitle}}</h5>\r\n            <span class=\"emp-contact\"><a>{{person.email}}</a> <span class=\"emp-view\"><a ng-href=\"{{person.profileUrl}}\">View Profile</a></span></span>\r\n        </div>\r\n    </div>\r\n</section>";

...
/***/ (function(module, exports) {
	...
	*/
	...
	(function () {
	    angular.module('compassionIntranet').service('graphService', ['$http', '$q', 'COM_CONFIG', function ($http, $q, COM_CONFIG) {
	        var ctrl = this;

            ...
            <div class="row">
                ...
                <div class="col-lg-4 main-right-rail">
                    ...
                    <!--trending-news-webpart-->
                      <div><PublishingWebControls:ContentByQueryWebPart runat="server" 
                          ItemStyle="TrendingNews" 
                          GroupStyle="DefaultHeader" 
                          ListName="" FilterField1="{0b784073-3117-4340-8475-a63c087a464e}" 
                          Filter1ChainingOperator="Or" 
                          Filter2ChainingOperator="Or" 
                          FilterOperator1="Leq" FilterDisplayValue1="[Today]" 
                          FilterValue1="[Today]" FilterType1="DateTime" 
                          DataMappingViewFields="{94f89715-e097-4e8b-ba79-ea02aa8b7adb},Lookup;{b9e6f3ae-5632-4b13-b636-9d1a2bd67120},Computed;{543bc2cf-1f30-488e-8f25-6fe3b689d9ac},Image;{fa564e0f-0c70-4ab9-b863-0177e6ddd247},Text;{691b9a4b-512e-4341-b3f1-68914130d5b2},Text;{60677f2d-9b5c-4278-9352-87cfee8a28ca},TaxonomyFieldType;{a0107484-a768-4873-9942-e33f818a8701},TaxonomyFieldType;{f1f1f3f0-639f-4240-9e77-9164aa7ebdf4},TaxonomyFieldType;{0b784073-3117-4340-8475-a63c087a464e},DateTime;" 
                          GroupByDirection="Desc" SortBy="{0b784073-3117-4340-8475-a63c087a464e}" 
                          SortByFieldType="DateTime" SortByDirection="Desc" ItemLimit="3" 
                          ...
                          MainXslLink="<% $SPUrl:~SiteCollection/Style Library/XSL Style Sheets/COM_ContentQueryMain.xsl %>" 
                          HeaderXslLink="<% $SPUrl:~SiteCollection/Style Library/XSL Style Sheets/COM_Header.xsl %>" 
                          ItemXslLink="<% $SPUrl:~SiteCollection/Style Library/XSL Style Sheets/COM_ItemStyle.xsl %>"
                          EnableOriginalValue="False" ViewFlag="0" ViewContentTypeId="" ListUrl="" ListDisplayName="" 
                          ListId="00000000-0000-0000-0000-000000000000" PageSize="-1" 
                          UseSQLDataSourcePaging="True" DataSourceID="" ShowWithSampleData="False" 
                          AsyncRefresh="False" ManualRefresh="False" AutoRefresh="False" AutoRefreshInterval="60" 
                          InitialAsyncDataFetch="False" Title="Trending News" FrameType="TitleBarOnly" 
                          SuppressWebPartChrome="False" 
                          Description="Displays a dynamic view of content from your site." 
                          IsIncluded="True" ZoneID="" PartOrder="0" FrameState="Normal" AllowRemove="False" 
                          AllowZoneChange="False" AllowMinimize="False" AllowConnect="False" AllowEdit="False" 
                          AllowHide="False" IsVisible="True" DetailLink="" HelpLink="" HelpMode="Modeless" Dir="Default" 
                          PartImageSmall="" MissingAssembly="Cannot import this Web Part." 
                          PartImageLarge="" IsIncludedFilter="" ExportControlledProperties="True" 
                          ConnectionID="00000000-0000-0000-0000-000000000000" ID="g_47e8e7bc_158d_4b4b_9456_9b274659e30e" 
                          ChromeType="TitleOnly" ExportMode="All" __MarkupType="vsattributemarkup" 
                          w__WebPartId="{47e8e7bc-158d-4b4b-9456-9b274659e30e}" WebPart="true" Height="" Width=""><Xsl><xsl:stylesheet version="1.0" exclude-result-prefixes="xsl cmswrt x"><xsl:import href="/Style Library/XSL Style Sheets/COM_Header.xsl" /><xsl:import href="/Style Library/XSL Style Sheets/COM_ItemStyle.xsl" /><xsl:import href="/Style Library/XSL Style Sheets/COM_ContentQueryMain.xsl" /></xsl:stylesheet></Xsl><SampleData><dsQueryResponse><Rows><Row Title="Item 1" LinkUrl="http://Item1" Group="Group Header" __begincolumn="True" __begingroup="True" /><Row Title="Item 2" LinkUrl="http://Item2" __begincolumn="False" __begingroup="False" /><Row Title="Item 3" LinkUrl="http://Item3" __begincolumn="False" __begingroup="False" /></Rows></dsQueryResponse></SampleData><DataFields /><ParameterBindings /></PublishingWebControls:ContentByQueryWebPart></div>
